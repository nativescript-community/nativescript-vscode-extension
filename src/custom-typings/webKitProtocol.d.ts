...
declare namespace Webkit {
    ...
    namespace ApplicationCache {
        ...
        // ApplicationCache
        interface ApplicationCache {
            getFramesWithManifests(): GetFramesWithManifestsResult; // // Returns array of frame identifiers with manifest urls for each frame containing a document associated with some application cache.
            enable(): any; // // Enables application cache domain notifications.
            getManifestForFrame(args: GetManifestForFrameParams ): GetManifestForFrameResult; // // Returns manifest URL for document in the given frame.
            getApplicationCacheForFrame(args: GetApplicationCacheForFrameParams ): GetApplicationCacheForFrameResult; // // Returns relevant application cache data for the document in given frame.
            onApplicationCacheStatusUpdated(args: ApplicationCacheStatusUpdatedEventArgs ): any; //
            onNetworkStateUpdated(args: NetworkStateUpdatedEventArgs ): any; //
        }
    ...
    namespace CSS {
        ...
        // CSS
        interface CSS {
            enable(): any; // // Enables the CSS agent for the given page. Clients should not assume that the CSS agent has been enabled until the result of this command is received.
            disable(): any; // // Disables the CSS agent for the given page.
            getMatchedStylesForNode(args: GetMatchedStylesForNodeParams ): GetMatchedStylesForNodeResult; // // Returns requested styles for a DOM node identified by <code>nodeId</code>.
            getInlineStylesForNode(args: GetInlineStylesForNodeParams ): GetInlineStylesForNodeResult; // // Returns the styles defined inline (explicitly in the "style" attribute and implicitly, using DOM attributes) for a DOM node identified by <code>nodeId</code>.
            getComputedStyleForNode(args: GetComputedStyleForNodeParams ): GetComputedStyleForNodeResult; // // Returns the computed style for a DOM node identified by <code>nodeId</code>.
            getAllStyleSheets(): GetAllStyleSheetsResult; // // Returns metainfo entries for all known stylesheets.
            getStyleSheet(args: GetStyleSheetParams ): GetStyleSheetResult; // // Returns stylesheet data for the specified <code>styleSheetId</code>.
            getStyleSheetText(args: GetStyleSheetTextParams ): GetStyleSheetTextResult; // // Returns the current textual content and the URL for a stylesheet.
            setStyleSheetText(args: SetStyleSheetTextParams ): any; // // Sets the new stylesheet text, thereby invalidating all existing <code>CSSStyleId</code>'s and <code>CSSRuleId</code>'s contained by this stylesheet.
            setStyleText(args: SetStyleTextParams ): SetStyleTextResult; // // Sets the new <code>text</code> for the respective style.
            setRuleSelector(args: SetRuleSelectorParams ): SetRuleSelectorResult; // // Modifies the rule selector.
            createStyleSheet(args: CreateStyleSheetParams ): CreateStyleSheetResult; // // Creates a new special "inspector" stylesheet in the frame with given <code>frameId</code>.
            addRule(args: AddRuleParams ): AddRuleResult; // // Creates a new empty rule with the given <code>selector</code> in a stylesheet with given <code>styleSheetId</code>.
            getSupportedCSSProperties(): GetSupportedCSSPropertiesResult; // // Returns all supported CSS property names.
            getSupportedSystemFontFamilyNames(): GetSupportedSystemFontFamilyNamesResult; // // Returns all supported system font family names.
            forcePseudoState(args: ForcePseudoStateParams ): any; // // Ensures that the given node will have specified pseudo-classes whenever its style is computed by the browser.
            getNamedFlowCollection(args: GetNamedFlowCollectionParams ): GetNamedFlowCollectionResult; // // Returns the Named Flows from the document.
            onMediaQueryResultChanged(): any; // // Fires whenever a MediaQuery result changes (for example, after a browser window has been resized.) The current implementation considers only viewport-dependent media features.
            onStyleSheetChanged(args: StyleSheetChangedEventArgs ): any; // // Fired whenever a stylesheet is changed as a result of the client operation.
            onStyleSheetAdded(args: StyleSheetAddedEventArgs ): any; // // Fired whenever an active document stylesheet is added.
            onStyleSheetRemoved(args: StyleSheetRemovedEventArgs ): any; // // Fired whenever an active document stylesheet is removed.
            onNamedFlowCreated(args: NamedFlowCreatedEventArgs ): any; // // Fires when a Named Flow is created.
            onNamedFlowRemoved(args: NamedFlowRemovedEventArgs ): any; // // Fires when a Named Flow is removed: has no associated content nodes and regions.
            onRegionOversetChanged(args: RegionOversetChangedEventArgs ): any; // // Fires if any of the regionOverset values changed in a Named Flow's region chain.
            onRegisteredNamedFlowContentElement(args: RegisteredNamedFlowContentElementEventArgs ): any; // // Fires when a Named Flow's has been registered with a new content node.
            onUnregisteredNamedFlowContentElement(args: UnregisteredNamedFlowContentElementEventArgs ): any; // // Fires when a Named Flow's has been registered with a new content node.
        }
    ...
    namespace Console {
        ...
        // Console
        interface Console {
            enable(): any; // // Enables console domain, sends the messages collected so far to the client by means of the <code>messageAdded</code> notification.
            disable(): any; // // Disables console domain, prevents further console messages from being reported to the client.
            clearMessages(): any; // // Clears console messages collected in the browser.
            setMonitoringXHREnabled(args: SetMonitoringXHREnabledParams ): any; // // Toggles monitoring of XMLHttpRequest. If <code>true</code>, console will receive messages upon each XHR issued.
            addInspectedNode(args: AddInspectedNodeParams ): any; // // Enables console to refer to the node with given id via $0 (see Command Line API for more details).
            onMessageAdded(args: MessageAddedEventArgs ): any; // // Issued when new console message is added.
            onMessageRepeatCountUpdated(args: MessageRepeatCountUpdatedEventArgs ): any; // // Issued when subsequent message(s) are equal to the previous one(s).
            onMessagesCleared(): any; // // Issued when console is cleared. This happens either upon <code>clearMessages</code> command or after page navigation.
        }
    ...
    namespace DOM {
        ...
        // DOM
        interface DOM {
            getDocument(): GetDocumentResult; // // Returns the root DOM node to the caller.
            requestChildNodes(args: RequestChildNodesParams ): any; // // Requests that children of the node with given id are returned to the caller in form of <code>setChildNodes</code> events where not only immediate children are retrieved, but all children down to the specified depth.
            querySelector(args: QuerySelectorParams ): QuerySelectorResult; // // Executes <code>querySelector</code> on a given node.
            querySelectorAll(args: QuerySelectorAllParams ): QuerySelectorAllResult; // // Executes <code>querySelectorAll</code> on a given node.
            setNodeName(args: SetNodeNameParams ): SetNodeNameResult; // // Sets node name for a node with given id.
            setNodeValue(args: SetNodeValueParams ): any; // // Sets node value for a node with given id.
            removeNode(args: RemoveNodeParams ): any; // // Removes node with given id.
            setAttributeValue(args: SetAttributeValueParams ): any; // // Sets attribute for an element with given id.
            setAttributesAsText(args: SetAttributesAsTextParams ): any; // // Sets attributes on element with given id. This method is useful when user edits some existing attribute value and types in several attribute name/value pairs.
            removeAttribute(args: RemoveAttributeParams ): any; // // Removes attribute with given name from an element with given id.
            getEventListenersForNode(args: GetEventListenersForNodeParams ): GetEventListenersForNodeResult; // // Returns event listeners relevant to the node.
            getAccessibilityPropertiesForNode(args: GetAccessibilityPropertiesForNodeParams ): GetAccessibilityPropertiesForNodeResult; // // Returns a dictionary of accessibility properties for the node.
            getOuterHTML(args: GetOuterHTMLParams ): GetOuterHTMLResult; // // Returns node's HTML markup.
            setOuterHTML(args: SetOuterHTMLParams ): any; // // Sets node HTML markup, returns new node id.
            performSearch(args: PerformSearchParams ): PerformSearchResult; // // Searches for a given string in the DOM tree. Use <code>getSearchResults</code> to access search results or <code>cancelSearch</code> to end this search session.
            getSearchResults(args: GetSearchResultsParams ): GetSearchResultsResult; // // Returns search results from given <code>fromIndex</code> to given <code>toIndex</code> from the sarch with the given identifier.
            discardSearchResults(args: DiscardSearchResultsParams ): any; // // Discards search results from the session with the given id. <code>getSearchResults</code> should no longer be called for that search.
            requestNode(args: RequestNodeParams ): RequestNodeResult; // // Requests that the node is sent to the caller given the JavaScript node object reference. All nodes that form the path from the node to the root are also sent to the client as a series of <code>setChildNodes</code> notifications.
            setInspectModeEnabled(args: SetInspectModeEnabledParams ): any; // // Enters the 'inspect' mode. In this mode, elements that user is hovering over are highlighted. Backend then generates 'inspect' command upon element selection.
            highlightRect(args: HighlightRectParams ): any; // // Highlights given rectangle. Coordinates are absolute with respect to the main frame viewport.
            highlightQuad(args: HighlightQuadParams ): any; // // Highlights given quad. Coordinates are absolute with respect to the main frame viewport.
            highlightSelector(args: HighlightSelectorParams ): any; // // Highlights all DOM nodes that match a given selector. A string containing a CSS selector must be specified.
            highlightNode(args: HighlightNodeParams ): any; // // Highlights DOM node with given id or with the given JavaScript object wrapper. Either nodeId or objectId must be specified.
            hideHighlight(): any; // // Hides DOM node highlight.
            highlightFrame(args: HighlightFrameParams ): any; // // Highlights owner element of the frame with given id.
            pushNodeByPathToFrontend(args: PushNodeByPathToFrontendParams ): PushNodeByPathToFrontendResult; // // Requests that the node is sent to the caller given its path. // FIXME, use XPath
            pushNodeByBackendIdToFrontend(args: PushNodeByBackendIdToFrontendParams ): PushNodeByBackendIdToFrontendResult; // // Requests that the node is sent to the caller given its backend node id.
            releaseBackendNodeIds(args: ReleaseBackendNodeIdsParams ): any; // // Requests that group of <code>BackendNodeIds</code> is released.
            resolveNode(args: ResolveNodeParams ): ResolveNodeResult; // // Resolves JavaScript node object for given node id.
            getAttributes(args: GetAttributesParams ): GetAttributesResult; // // Returns attributes for the specified node.
            moveTo(args: MoveToParams ): MoveToResult; // // Moves node into the new container, places it before the given anchor.
            undo(): any; // // Undoes the last performed action.
            redo(): any; // // Re-does the last undone action.
            markUndoableState(): any; // // Marks last undoable state.
            focus(args: FocusParams ): any; // // Focuses the given element.
            onDocumentUpdated(): any; // // Fired when <code>Document</code> has been totally updated. Node ids are no longer valid.
            onSetChildNodes(args: SetChildNodesEventArgs ): any; // // Fired when backend wants to provide client with the missing DOM structure. This happens upon most of the calls requesting node ids.
            onAttributeModified(args: AttributeModifiedEventArgs ): any; // // Fired when <code>Element</code>'s attribute is modified.
            onAttributeRemoved(args: AttributeRemovedEventArgs ): any; // // Fired when <code>Element</code>'s attribute is removed.
            onInlineStyleInvalidated(args: InlineStyleInvalidatedEventArgs ): any; // // Fired when <code>Element</code>'s inline style is modified via a CSS property modification.
            onCharacterDataModified(args: CharacterDataModifiedEventArgs ): any; // // Mirrors <code>DOMCharacterDataModified</code> event.
            onChildNodeCountUpdated(args: ChildNodeCountUpdatedEventArgs ): any; // // Fired when <code>Container</code>'s child node count has changed.
            onChildNodeInserted(args: ChildNodeInsertedEventArgs ): any; // // Mirrors <code>DOMNodeInserted</code> event.
            onChildNodeRemoved(args: ChildNodeRemovedEventArgs ): any; // // Mirrors <code>DOMNodeRemoved</code> event.
            onShadowRootPushed(args: ShadowRootPushedEventArgs ): any; // // Called when shadow root is pushed into the element.
            onShadowRootPopped(args: ShadowRootPoppedEventArgs ): any; // // Called when shadow root is popped from the element.
            onPseudoElementAdded(args: PseudoElementAddedEventArgs ): any; // // Called when a pseudo element is added to an element.
            onPseudoElementRemoved(args: PseudoElementRemovedEventArgs ): any; // // Called when a pseudo element is removed from an element.
        }
    ...
    namespace DOMDebugger {
        ...
        interface DOMDebugger {
            setDOMBreakpoint(args: SetDOMBreakpointParams ): any; // // Sets breakpoint on particular operation with DOM.
            removeDOMBreakpoint(args: RemoveDOMBreakpointParams ): any; // // Removes DOM breakpoint that was set using <code>setDOMBreakpoint</code>.
            setEventListenerBreakpoint(args: SetEventListenerBreakpointParams ): any; // // Sets breakpoint on particular DOM event.
            removeEventListenerBreakpoint(args: RemoveEventListenerBreakpointParams ): any; // // Removes breakpoint on particular DOM event.
            setInstrumentationBreakpoint(args: SetInstrumentationBreakpointParams ): any; // // Sets breakpoint on particular native event.
            removeInstrumentationBreakpoint(args: RemoveInstrumentationBreakpointParams ): any; // // Sets breakpoint on particular native event.
            setXHRBreakpoint(args: SetXHRBreakpointParams ): any; // // Sets breakpoint on XMLHttpRequest.
            removeXHRBreakpoint(args: RemoveXHRBreakpointParams ): any; // // Removes breakpoint from XMLHttpRequest.
        }
    ...
    namespace DOMStorage {
        ...
        interface DOMStorage {
            enable(): any; // // Enables storage tracking, storage events will now be delivered to the client.
            disable(): any; // // Disables storage tracking, prevents storage events from being sent to the client.
            getDOMStorageItems(args: GetDOMStorageItemsParams ): GetDOMStorageItemsResult; //
            setDOMStorageItem(args: SetDOMStorageItemParams ): any; //
            removeDOMStorageItem(args: RemoveDOMStorageItemParams ): any; //
            onDomStorageItemsCleared(args: DomStorageItemsClearedEventArgs ): any; //
            onDomStorageItemRemoved(args: DomStorageItemRemovedEventArgs ): any; //
            onDomStorageItemAdded(args: DomStorageItemAddedEventArgs ): any; //
            onDomStorageItemUpdated(args: DomStorageItemUpdatedEventArgs ): any; //
        }
    ...
    namespace Database {
        ...
        // Database
        interface Database {
            enable(): any; // // Enables database tracking, database events will now be delivered to the client.
            disable(): any; // // Disables database tracking, prevents database events from being sent to the client.
            getDatabaseTableNames(args: GetDatabaseTableNamesParams ): GetDatabaseTableNamesResult; //
            executeSQL(args: ExecuteSQLParams ): ExecuteSQLResult; //
            onAddDatabase(args: AddDatabaseEventArgs ): any; //
        }
    ...
    namespace Debugger {
        ...
        // Debugger
        interface Debugger {
            enable(): any; // // Enables debugger for the given page. Clients should not assume that the debugging has been enabled until the result for this command is received.
            disable(): any; // // Disables debugger for given page.
            setBreakpointsActive(args: SetBreakpointsActiveParams ): any; // // Activates / deactivates all breakpoints on the page.
            setBreakpointByUrl(args: SetBreakpointByUrlParams ): SetBreakpointByUrlResult; // // Sets JavaScript breakpoint at given location specified either by URL or URL regex. Once this command is issued, all existing parsed scripts will have breakpoints resolved and returned in <code>locations</code> property. Further matching script parsing will result in subsequent <code>breakpointResolved</code> events issued. This logical breakpoint will survive page reloads.
            setBreakpoint(args: SetBreakpointParams ): SetBreakpointResult; // // Sets JavaScript breakpoint at a given location.
            removeBreakpoint(args: RemoveBreakpointParams ): any; // // Removes JavaScript breakpoint.
            continueToLocation(args: ContinueToLocationParams ): any; // // Continues execution until specific location is reached.
            stepOver(): any; // // Steps over the statement.
            stepInto(): any; // // Steps into the function call.
            stepOut(): any; // // Steps out of the function call.
            pause(): any; // // Stops on the next JavaScript statement.
            resume(): any; // // Resumes JavaScript execution.
            searchInContent(args: SearchInContentParams ): SearchInContentResult; // // Searches for given string in script content.
            getScriptSource(args: GetScriptSourceParams ): GetScriptSourceResult; // // Returns source for the script with given id.
            getFunctionDetails(args: GetFunctionDetailsParams ): GetFunctionDetailsResult; // // Returns detailed information on given function.
            setPauseOnExceptions(args: SetPauseOnExceptionsParams ): any; // // Defines pause on exceptions state. Can be set to stop on all exceptions, uncaught exceptions or no exceptions. Initial pause on exceptions state is <code>none</code>.
            evaluateOnCallFrame(args: EvaluateOnCallFrameParams ): EvaluateOnCallFrameResult; // // Evaluates expression on a given call frame.
            setOverlayMessage(args: SetOverlayMessageParams ): any; // // Sets overlay message.
            onGlobalObjectCleared(): any; // // Called when global has been cleared and debugger client should reset its state. Happens upon navigation or reload.
            onScriptParsed(args: ScriptParsedEventArgs ): any; // // Fired when virtual machine parses script. This event is also fired for all known and uncollected scripts upon enabling debugger.
            onScriptFailedToParse(args: ScriptFailedToParseEventArgs ): any; // // Fired when virtual machine fails to parse the script.
            onBreakpointResolved(args: BreakpointResolvedEventArgs ): any; // // Fired when breakpoint is resolved to an actual script and location.
            onPaused(args: PausedEventArgs ): any; // // Fired when the virtual machine stopped on breakpoint or exception or any other stop criteria.
            onResumed(): any; // // Fired when the virtual machine resumed execution.
            onDidSampleProbe(args: DidSampleProbeEventArgs ): any; // // Fires when a new probe sample is collected.
            onPlayBreakpointActionSound(args: PlayBreakpointActionSoundEventArgs ): any; // // Fired when a "sound" breakpoint action is triggered on a breakpoint.
        }
    ...
    namespace Heap {
        ...
        // Heap
        interface Heap {
            enable(): any; // // Enables Heap domain events.
            disable(): any; // // Disables Heap domain events.
            gc(): any; // // Trigger a full garbage collection.
            onGarbageCollected(args: GarbageCollectedEventArgs ): any; // // Information about the garbage collection.
        }
    ...
    namespace IndexedDB {
        ...
        // IndexedDB
        interface IndexedDB {
            enable(): any; // // Enables events from backend.
            disable(): any; // // Disables events from backend.
            requestDatabaseNames(args: RequestDatabaseNamesParams ): RequestDatabaseNamesResult; // // Requests database names for given security origin.
            requestDatabase(args: RequestDatabaseParams ): RequestDatabaseResult; // // Requests database with given name in given frame.
            requestData(args: RequestDataParams ): RequestDataResult; // // Requests data from object store or index.
            clearObjectStore(args: ClearObjectStoreParams ): ClearObjectStoreResult; // // Clears all entries from an object store.
        }
    ...
    namespace Inspector {
        ...
        // Inspector
        interface Inspector {
            enable(): any; // // Enables inspector domain notifications.
            disable(): any; // // Disables inspector domain notifications.
            initialized(): any; // // Sent by the frontend after all initialization messages have been sent.
            onEvaluateForTestInFrontend(args: EvaluateForTestInFrontendEventArgs ): any; //
            onInspect(args: InspectEventArgs ): any; //
            onDetached(args: DetachedEventArgs ): any; // // Fired when remote debugging connection is about to be terminated. Contains detach reason.
            onActivateExtraDomains(args: ActivateExtraDomainsEventArgs ): any; // // Fired when the backend has alternate domains that need to be activated.
            onTargetCrashed(): any; // // Fired when debugging target has crashed
        }
    ...
    namespace LayerTree {
        ...
        // LayerTree
        interface LayerTree {
            enable(): any; // // Enables compositing tree inspection.
            disable(): any; // // Disables compositing tree inspection.
            layersForNode(args: LayersForNodeParams ): LayersForNodeResult; // // Returns the layer tree structure of the current page.
            reasonsForCompositingLayer(args: ReasonsForCompositingLayerParams ): ReasonsForCompositingLayerResult; // // Provides the reasons why the given layer was composited.
            onLayerTreeDidChange(): any; //
        }
    ...
    namespace Network {
        ...
        // Network
        interface Network {
            enable(): any; // // Enables network tracking, network events will now be delivered to the client.
            disable(): any; // // Disables network tracking, prevents network events from being sent to the client.
            setExtraHTTPHeaders(args: SetExtraHTTPHeadersParams ): any; // // Specifies whether to always send extra HTTP headers with the requests from this page.
            getResponseBody(args: GetResponseBodyParams ): GetResponseBodyResult; // // Returns content served for the given request.
            setCacheDisabled(args: SetCacheDisabledParams ): any; // // Toggles ignoring cache for each request. If <code>true</code>, cache will not be used.
            loadResource(args: LoadResourceParams ): LoadResourceResult; // // Loads a resource in the context of a frame on the inspected page without cross origin checks.
            onRequestWillBeSent(args: RequestWillBeSentEventArgs ): any; // // Fired when page is about to send HTTP request.
            onRequestServedFromCache(args: RequestServedFromCacheEventArgs ): any; // // Fired if request ended up loading from cache.
            onResponseReceived(args: ResponseReceivedEventArgs ): any; // // Fired when HTTP response is available.
            onDataReceived(args: DataReceivedEventArgs ): any; // // Fired when data chunk was received over the network.
            onLoadingFinished(args: LoadingFinishedEventArgs ): any; // // Fired when HTTP request has finished loading.
            onLoadingFailed(args: LoadingFailedEventArgs ): any; // // Fired when HTTP request has failed to load.
            onRequestServedFromMemoryCache(args: RequestServedFromMemoryCacheEventArgs ): any; // // Fired when HTTP request has been served from memory cache.
            onWebSocketWillSendHandshakeRequest(args: WebSocketWillSendHandshakeRequestEventArgs ): any; // // Fired when WebSocket is about to initiate handshake.
            onWebSocketHandshakeResponseReceived(args: WebSocketHandshakeResponseReceivedEventArgs ): any; // // Fired when WebSocket handshake response becomes available.
            onWebSocketCreated(args: WebSocketCreatedEventArgs ): any; // // Fired upon WebSocket creation.
            onWebSocketClosed(args: WebSocketClosedEventArgs ): any; // // Fired when WebSocket is closed.
            onWebSocketFrameReceived(args: WebSocketFrameReceivedEventArgs ): any; // // Fired when WebSocket frame is received.
            onWebSocketFrameError(args: WebSocketFrameErrorEventArgs ): any; // // Fired when WebSocket frame error occurs.
            onWebSocketFrameSent(args: WebSocketFrameSentEventArgs ): any; // // Fired when WebSocket frame is sent.
        }
    ...
    namespace Page {
        ...
        // Page
        interface Page {
            enable(): any; // // Enables page domain notifications.
            disable(): any; // // Disables page domain notifications.
            addScriptToEvaluateOnLoad(args: AddScriptToEvaluateOnLoadParams ): AddScriptToEvaluateOnLoadResult; //
            removeScriptToEvaluateOnLoad(args: RemoveScriptToEvaluateOnLoadParams ): any; //
            reload(args: ReloadParams ): any; // // Reloads given page optionally ignoring the cache.
            navigate(args: NavigateParams ): any; // // Navigates current page to the given URL.
            getCookies(): GetCookiesResult; // // Returns all browser cookies. Depending on the backend support, will return detailed cookie information in the <code>cookies</code> field.
            deleteCookie(args: DeleteCookieParams ): any; // // Deletes browser cookie with given name, domain and path.
            getResourceTree(): GetResourceTreeResult; // // Returns present frame / resource tree structure.
            getResourceContent(args: GetResourceContentParams ): GetResourceContentResult; // // Returns content of the given resource.
            searchInResource(args: SearchInResourceParams ): SearchInResourceResult; // // Searches for given string in resource content.
            searchInResources(args: SearchInResourcesParams ): SearchInResourcesResult; // // Searches for given string in frame / resource tree structure.
            setDocumentContent(args: SetDocumentContentParams ): any; // // Sets given markup as the document's HTML.
            setShowPaintRects(args: SetShowPaintRectsParams ): any; // // Requests that backend shows paint rectangles
            getScriptExecutionStatus(): GetScriptExecutionStatusResult; // // Determines if scripts can be executed in the page.
            setScriptExecutionDisabled(args: SetScriptExecutionDisabledParams ): any; // // Switches script execution in the page.
            setTouchEmulationEnabled(args: SetTouchEmulationEnabledParams ): any; // // Toggles mouse event-based touch event emulation.
            setEmulatedMedia(args: SetEmulatedMediaParams ): any; // // Emulates the given media for CSS media queries.
            getCompositingBordersVisible(): GetCompositingBordersVisibleResult; // // Indicates the visibility of compositing borders.
            setCompositingBordersVisible(args: SetCompositingBordersVisibleParams ): any; // // Controls the visibility of compositing borders.
            snapshotNode(args: SnapshotNodeParams ): SnapshotNodeResult; // // Capture a snapshot of the specified node that does not include unrelated layers.
            snapshotRect(args: SnapshotRectParams ): SnapshotRectResult; // // Capture a snapshot of the page within the specified rectangle and coordinate system.
            handleJavaScriptDialog(args: HandleJavaScriptDialogParams ): any; // // Accepts or dismisses a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload).
            archive(): ArchiveResult; // // Grab an archive of the page.
            onDomContentEventFired(args: DomContentEventFiredEventArgs ): any; //
            onLoadEventFired(args: LoadEventFiredEventArgs ): any; //
            onFrameNavigated(args: FrameNavigatedEventArgs ): any; // // Fired once navigation of the frame has completed. Frame is now associated with the new loader.
            onFrameDetached(args: FrameDetachedEventArgs ): any; // // Fired when frame has been detached from its parent.
            onFrameStartedLoading(args: FrameStartedLoadingEventArgs ): any; // // Fired when frame has started loading.
            onFrameStoppedLoading(args: FrameStoppedLoadingEventArgs ): any; // // Fired when frame has stopped loading.
            onFrameScheduledNavigation(args: FrameScheduledNavigationEventArgs ): any; // // Fired when frame schedules a potential navigation.
            onFrameClearedScheduledNavigation(args: FrameClearedScheduledNavigationEventArgs ): any; // // Fired when frame no longer has a scheduled navigation.
            onJavascriptDialogOpening(args: JavascriptDialogOpeningEventArgs ): any; // // Fired when a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload) is about to open.
            onJavascriptDialogClosed(): any; // // Fired when a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload) has been closed.
            onScriptsEnabled(args: ScriptsEnabledEventArgs ): any; // // Fired when the JavaScript is enabled/disabled on the page
        }
    ...
    namespace Replay {
        ...
        // Replay
        interface Replay {
            startCapturing(): any; // // Starts capture of a new replay session.
            stopCapturing(): any; // // Stops capture of the currently recording replay session.
            replayToPosition(args: ReplayToPositionParams ): any; // // Seek execution to a specific position within the replay session.
            replayToCompletion(args: ReplayToCompletionParams ): any; // // Replay all session segments completely.
            pausePlayback(): any; // // Pauses playback in the current segment. Can be resumed by using a replay command.
            cancelPlayback(): any; // // Cancels playback of the current segment. Further replaying will start from the beginning of the current segment.
            switchSession(args: SwitchSessionParams ): any; // // Unloads the current replay session and loads the specified session
            insertSessionSegment(args: InsertSessionSegmentParams ): any; // // Splices the specified session segment into the session at the specified index.
            removeSessionSegment(args: RemoveSessionSegmentParams ): any; // // Removes the session segment at the specified position from the session.
            currentReplayState(): CurrentReplayStateResult; // // Returns the identifier, position, session state and segment state of the currently loaded session. This is necessary because the inspector may be closed and reopened in the middle of replay.
            getAvailableSessions(): GetAvailableSessionsResult; // // Returns identifiers of all available sessions.
            getSessionData(args: GetSessionDataParams ): GetSessionDataResult; // // Returns an object for the specified session.
            getSegmentData(args: GetSegmentDataParams ): GetSegmentDataResult; // // Returns an object for the specified session segment.
            onCaptureStarted(): any; // // Fired when capture has started.
            onCaptureStopped(): any; // // Fired when capture has stopped.
            onPlaybackHitPosition(args: PlaybackHitPositionEventArgs ): any; // // Playback within the session has progressed up to this position, and is about to replay the input at the specified offset.
            onPlaybackStarted(): any; // // Fired when session playback has started.
            onPlaybackPaused(args: PlaybackPausedEventArgs ): any; // // Fired when session playback has paused, but not finished.
            onPlaybackFinished(): any; // // Fired when session playback has stopped.
            onInputSuppressionChanged(args: InputSuppressionChangedEventArgs ): any; // // Fired when the replay controller starts or stops suppressing user inputs.
            onSessionCreated(args: SessionCreatedEventArgs ): any; // // Fired when a new replay session is created
            onSessionModified(args: SessionModifiedEventArgs ): any; // // Fired when a session's segments have changed.
            onSessionRemoved(args: SessionRemovedEventArgs ): any; // // Fired when a replay session is removed and can no longer be loaded.
            onSessionLoaded(args: SessionLoadedEventArgs ): any; // // Fired when a replay session is loaded.
            onSegmentCreated(args: SegmentCreatedEventArgs ): any; // // Fired when a new session segment is created.
            onSegmentRemoved(args: SegmentRemovedEventArgs ): any; // // Fired when a session segment is removed and can no longer be replayed as part of a session.
            onSegmentCompleted(args: SegmentCompletedEventArgs ): any; // // Fired when a session segment is completed and can no longer have inputs added to it.
            onSegmentLoaded(args: SegmentLoadedEventArgs ): any; // // Fired when a segment is loaded.
            onSegmentUnloaded(): any; // // Fired when a segment is unloaded.
        }
    ...
    namespace Runtime {
        ...
        // Runtime
        interface Runtime {
            parse(args: ParseParams ): ParseResult; // // Parses JavaScript source code for errors.
            evaluate(args: EvaluateParams ): EvaluateResult; // // Evaluates expression on global object.
            callFunctionOn(args: CallFunctionOnParams ): CallFunctionOnResult; // // Calls function with given declaration on the given object. Object group of the result is inherited from the target object.
            getProperties(args: GetPropertiesParams ): GetPropertiesResult; // // Returns properties of a given object. Object group of the result is inherited from the target object.
            getDisplayableProperties(args: GetDisplayablePropertiesParams ): GetDisplayablePropertiesResult; // // Returns displayable properties of a given object. Object group of the result is inherited from the target object. Displayable properties are own properties, internal properties, and native getters in the prototype chain (assumed to be bindings and treated like own properties for the frontend).
            getCollectionEntries(args: GetCollectionEntriesParams ): GetCollectionEntriesResult; // // Returns entries of given Map / Set collection.
            saveResult(args: SaveResultParams ): SaveResultResult; // // Assign a saved result index to this value.
            releaseObject(args: ReleaseObjectParams ): any; // // Releases remote object with given id.
            releaseObjectGroup(args: ReleaseObjectGroupParams ): any; // // Releases all remote objects that belong to a given group.
            run(): any; // // Tells inspected instance(worker or page) that it can run in case it was started paused.
            enable(): any; // // Enables reporting of execution contexts creation by means of <code>executionContextCreated</code> event. When the reporting gets enabled the event will be sent immediately for each existing execution context.
            disable(): any; // // Disables reporting of execution contexts creation.
            getRuntimeTypesForVariablesAtOffsets(args: GetRuntimeTypesForVariablesAtOffsetsParams ): GetRuntimeTypesForVariablesAtOffsetsResult; // // Returns detailed informtation on given function.
            enableTypeProfiler(): any; // // Enables type profiling on the VM.
            disableTypeProfiler(): any; // // Disables type profiling on the VM.
            getBasicBlocks(args: GetBasicBlocksParams ): GetBasicBlocksResult; // // Returns a list of basic blocks for the given sourceID with information about their text ranges and whether or not they have executed.
            onExecutionContextCreated(args: ExecutionContextCreatedEventArgs ): any; // // Issued when new execution context is created.
        }
    ...
    namespace Timeline {
        ...
        // Timeline
        interface Timeline {
            start(args: StartParams ): any; // // Starts capturing instrumentation events.
            stop(): any; // // Stops capturing instrumentation events.
            onEventRecorded(args: EventRecordedEventArgs ): any; // // Fired for every instrumentation event while timeline is started.
            onRecordingStarted(args: RecordingStartedEventArgs ): any; // // Fired when recording has started.
            onRecordingStopped(args: RecordingStoppedEventArgs ): any; // // Fired when recording has stopped.
        }
    ...
    namespace Worker {
        ...
        interface Worker {
            enable(): any; //
            disable(): any; //
            sendMessageToWorker(args: SendMessageToWorkerParams ): any; //
            canInspectWorkers(): CanInspectWorkersResult; // // Tells whether browser supports workers inspection.
            connectToWorker(args: ConnectToWorkerParams ): any; //
            disconnectFromWorker(args: DisconnectFromWorkerParams ): any; //
            setAutoconnectToWorkers(args: SetAutoconnectToWorkersParams ): any; //
            onWorkerCreated(args: WorkerCreatedEventArgs ): any; //
            onWorkerTerminated(args: WorkerTerminatedEventArgs ): any; //
            onDispatchMessageFromWorker(args: DispatchMessageFromWorkerEventArgs ): any; //
            onDisconnectedFromWorker(): any; //
        }
